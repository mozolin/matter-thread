...
alias get_chip='set savePath=$PWD;cd ~/esp-matter/connectedhomeip/connectedhomeip;. scripts/activate.sh;cd $savePath'
...
alias set_env='get_idf; get_matter; get_chip; set_cache'
